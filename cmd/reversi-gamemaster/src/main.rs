...
use aiarena_protocol::{
    ...
    gamemaster::{
        ...
        METHOD_CURRENT_PUBLIC_REPLAY, METHOD_CURRENT_RESULT, METHOD_CURRENT_SNAPSHOT,
        METHOD_INITIALIZE_MATCH, METHOD_METADATA, METHOD_NEXT_DECISION_STEP,
        METHOD_NORMALIZE_ACTION, METHOD_SHUTDOWN,
    },
};
use reversi_game::{
    game_metadata,
